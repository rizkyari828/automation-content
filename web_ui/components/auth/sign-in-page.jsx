                  ...
                  <div className="card card-plain">
                    ...
                    <div className="card-body">
                      <form role="form">
                        ...
                        <div className="mb-3">
                          <input type="password" className="form-control form-control-lg" placeholder="Password" aria-label="Password" />
                        </div>
                        ...
                        <div className="text-center">
                          <button type="button" className="btn btn-lg btn-primary w-100 mt-4 mb-0">Sign in</button>
                        </div>
                      </form>
                    </div>
