...
export async function POST(request, { params }) {
  ...
  const result = await gatewayFetchWithSession(request, `/v1/content/templates/${resolvedParams.templateId}/clone`, {
    method: "POST",
    headers: {
  ...
  const response = createJsonResponse(payload ?? { message: "Unable to clone content template" }, {
