...
export async function POST(request, { params }) {
  ...
  const result = await gatewayFetchWithSession(request, `/v1/content/templates/${resolvedParams.templateId}/archive`, {
    method: "POST",
    headers: {
  ...
  const response = createJsonResponse(payload ?? { message: "Unable to archive content template" }, {
